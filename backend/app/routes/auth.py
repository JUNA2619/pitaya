...
def registro(data: RegistroRequest):
    ...
    if existente.data:
        raise HTTPException(status_code=400, detail="Este correo ya está registrado. Intente con otro o inicie sesión.")
...
def login(data: LoginRequest):
    ...
    if not resultado.data:
        raise HTTPException(status_code=401, detail="Correo o contraseña incorrectos. Verifique sus datos e intente de nuevo.")
